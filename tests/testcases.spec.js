...
test("User Login with incorrect email and password", async ({ page }) => {
  console.log("Navigating to website...");
  await page.goto("https://www.automationexercise.com/");
  ...
  const errorMessage = await page.locator("p").first().textContent();

  // Use the `expect` assertion to check for the error message
